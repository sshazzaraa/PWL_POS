...
class TransaksiPenjualanController extends Controller
{
    ...
    {
        $transaksis = PenjualanDetail::select('penjualan_id', 'user_id', 'pembeli', 'penjualan_kode', 'penjualan_tanggal')
            ->with('user');
    ...
    {
        $transaksi = PenjualanDetail::with('user')->find($id);
        $breadcrumb = (object) [
    ...
    {
        $transaksi = PenjualanDetail::find($id);
        $user = User::all();
    ...
    public function update(Request $request, string $id)
    {
        ...
        PenjualanDetail::find($id)->update([
            'user_id' => $request->user_id,
            'pembeli' => $request->pembeli,
            'penjualan_kode' => $request->penjualan_kode,
            'penjualan_tanggal' => $request->penjualan_tanggal,
